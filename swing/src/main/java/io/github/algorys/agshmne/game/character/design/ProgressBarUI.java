package io.github.algorys.agshmne.game.character.design;
...
public class ProgressBarUI extends BasicProgressBarUI {
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        Color[] colors = {progressBar.getForeground(), progressBar.getForeground().brighter(), progressBar.getBackground()};
