...
public class InventoryTest {
	...
	public void newInventory_should_NOT_contains_Apple() {
		...
		assertFalse(underTest.contains(new StackableItem("Pomme", 1)));
	}
	...
	public void inventoryWithApple_should_NOT_contains_Nails() {
		...
		Item apple = new StackableItem("Pomme", 1);
		underTest.addItem(apple);
		assertFalse(underTest.contains(new StackableItem("Clou", 1)));
	}

	@Test
	public void inventoryWithNail_should_contains_Nails() {
		Inventory underTest = new Inventory();
		underTest.addItem(new StackableItem("Clou", 1));
		assertTrue(underTest.contains(new StackableItem("Clou", 1)));
	}

	@Test
	public void inventoryWithOrange_should_contains_Orange_but_NOT_Apple_NOR_Nails() {
		Inventory underTest = new Inventory();
		underTest.addItem(new StackableItem("Orange", 1));
		assertTrue(underTest.contains(new StackableItem("Orange", 1)));
		assertFalse(underTest.contains(new StackableItem("Pomme", 1)));
		assertFalse(underTest.contains(new StackableItem("Clou", 1)));
	}
	...
	public void inventoryWithTwoAxe_should_contains_Axe_when_one_is_removed() {
		...
		underTest.addItem(new EquipableItem("Hache", BodyPart.RIGHT_HAND));
		assertEquals(2, underTest.count(new EquipableItem("Hache", BodyPart.RIGHT_HAND)));
		underTest.removeItem(axe);
		assertTrue(underTest.contains(new EquipableItem("Hache", BodyPart.RIGHT_HAND)));
	}

	@Test
	public void inventoryWith2Apple_should_have_2_apple() {
		Inventory underTest = new Inventory();
		underTest.addItem(new StackableItem("Pomme", 1));
		underTest.addItem(new StackableItem("Pomme", 1));
		assertEquals(2, underTest.count(new StackableItem("Pomme", 1)));
	}
	...
	public void inventoryWith3Apple_should_have_3_apple() {
		...
		underTest.addItem(new StackableItem("Pomme", 1));
		underTest.addItem(new StackableItem("Pomme", 1));
		assertEquals(3, underTest.count(new StackableItem("Pomme", 1)));
	}

	@Test
	public void inventoryWith2Orange_and_Remove2Orange_should_have_0_orange() {
		Inventory underTest = new Inventory();
		underTest.addItem(new StackableItem("Orange", 2));
		underTest.removeItem(new StackableItem("Orange", 2));
		assertFalse(underTest.contains(new StackableItem("Orange", 1)));
	}
